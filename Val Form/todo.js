...
function buildForm(arr) {
    ...
    for (let item of arr) {
        ...
        function addSelect(item){ //добавить функции
...
function validate(field) {
    if (!field.value) {
        ...
        if (!field.nextElementSibling) {
            field.insertAdjacentHTML('afterend', '<p class="error-message">Must contain at least 1 character</p>'); //createTextNode
        }
        return false;
    } else {
